...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand d-flex" href="{{ url('/') }}">
                    <div><img src="/svg/instagramLogo.svg" style="height: 24px; border-right: 1px solid #333;" class="pr-3"> </div>
        ...
        <div class="fixed-bottom">
                <ul class="nav justify-content-center pt-2" style="background-color:#F0F0F0;">
                    <li class="nav-item">
                        <a class="nav-link active" href="#"> <img src="/svg/instagramHome.svg" style="height: 24px;"> </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#"> <img src="/svg/instagramUser.svg" style="height: 24px;"> </a>
                    </li>
                </ul>
        </div>
